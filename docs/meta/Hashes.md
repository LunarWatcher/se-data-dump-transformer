...
Note: 2026-06-30 has proven difficult to acquire due to rampant download failures caused by SE's servers/cloudflare/whereever the data actually is stored being incredibly flaky, and has therefore not been independently verified.
